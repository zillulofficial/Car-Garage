                        ...
                        <div className="hero-content border-2 rounded-lg p-5">
                            <div className=" shrink-0 w-full bg-base-100">
                                <form onSubmit={handleSubmit} className="card-body">
                                    <div>
                                        <h3 className="text-4xl text-[#444444] roboto font-semibold mb-6 text-center">Sign Up</h3>
                                        <p className="roboto text-[#9c9c9c9c] mb-5">Provide your credentials to create your account.</p>
                                    </div>
