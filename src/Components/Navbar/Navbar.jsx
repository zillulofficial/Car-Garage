                        ...
                        user ? <>
                            <div className="navbar-end flex items-center gap-3">
                                <div className="dropdown dropdown-end dropdown-hover">
                                    <div tabIndex={0} role="button" className=" m-1"><a className="my-anchor-element"><img className="w-10 rounded-full" src={user.photoURL? user.photoURL: "https://img.daisyui.com/images/stock/photo-1534528741775-53994a69daeb.jpg"} alt="" /></a></div>
                                    <Tooltip anchorSelect=".my-anchor-element" place="left" className="bg-[#1abc9c66]">
                                        <p>{user.email}</p>
                                    </Tooltip>
                                </div>
                                <button onClick={handleLogout} className="btn text-[#FF3811] bg-none border border-[#FF3811] hover:text-white hover:bg-[#FF3811] hover:border-none">Logout</button>
                            </div>
                        </>
                            :
