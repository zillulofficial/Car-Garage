                ...
                <div id="slide1" className="carousel-item relative w-full ">
                    ...
                    <div className="absolute h-full top-0 bg-gradient-to-r from-[#151515] gap-5  w-1/3 flex items-center">
                        <div className="pl-12 space-y-7">
                            <h1 className="text-white text-6xl font-bold text-roboto">Affordable Price For Car Servicing</h1>
                            <p className="text-white text-roboto">There are many variations of passages of  available, but the majority have suffered alteration in some form</p>
                            <div>
